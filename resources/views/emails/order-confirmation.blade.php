        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <p style="font-size: 14px; color: #666660; margin: 0; text-align: center;">
                    Questions about your order? Contact us anytime at <a href="mailto:{{ config('shop.company.email', 'info@ever-grove.co.uk') }}" style="color: #191919; font-weight: 600;">{{ config('shop.company.email', 'info@ever-grove.co.uk') }}</a>.
                </p>
            </div>

            <!-- Footer & Legal Entity Invoice Details -->
            <div class="footer">
